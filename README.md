...
- Professional responsive 2.6.0 interface with searchable Ctrl/Cmd+K navigation, active-module command bar, live evidence context rail, refined cards/forms/modals, accessible themes, mobile touch rail, forced colours, reduced motion, and print layouts
